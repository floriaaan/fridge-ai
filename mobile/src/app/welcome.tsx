 ...
 * same motion. Sign-up, not sign-in: every visitor who reaches this screen
 * has, by construction, never used the app on this device before — the flag
 * this screen sets is the only thing standing between a fresh install and
 * seeing it again. Landing that visitor on sign-in's "Content de te revoir"
 * greeted them as a returning user on their actual first visit (a real
 * critique finding, not a guess) and buried the form they needed behind a
 * 13px "Pas de compte ?" link.
 */
